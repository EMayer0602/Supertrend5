...
'''        fig.add_trace(
        ...
        filtered_plot_df = plot_df[(plot_df['Ticker'] == 'AAPL') & (plot_df.index >= '2025-03-01')]
...
# Add slider to equity chart
        ...
        fig.update_yaxes(
            range=[combined_equity.min() * 1.55, combined_equity.max() * 1.5],  # Adjust range
            row=2, col=1
        )
